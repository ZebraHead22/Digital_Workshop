...
В данном курсе мы будем изучать объектно-ориентированное программирование на языке Python. Для лучшего понимания и получения более подробной информации рекомендую [скачать книгу](https://disk.yandex.ru/i/eR99Y4Ukcum-3Q).
...
- Калькулятор
- Тетрис
- MP3-плеер (Проект для прослушивания музыки. Создайте MP3-плеер с плейлистами, перемоткой, зацикливанием аудиозаписей и другими полезными функциями. Для реализации могут понадобиться библиотеки для работы с GUI `Tkinter` или `PyQt`, для работы с аудио может понадобиться библиотека `librosa`.)
- Тест скорости набора текста (Проект позволит определить скорость набора текста пользователем. Реализуйте графический интерфейс с помощью библиотеки для работы с GUI, например, `Tkinter` или `PyQt`. От пользователя потребуется вводить текст. После ввода текста приложение выведет информацию о скорости набора, точности и количестве набранных слов в минуту.)
- Файловый менеджер (Проект для работы с файлами в системе. Например, аналог проводника в Windows. С помощью этого приложения можно просматривать, редактировать, перемещать, удалять файлы в системе. Проект затронет различные области знаний языка Python.)
- Любой свой проект.
...
[Занятие 7. Контрольная работа №1](https://drive.google.com/file/d/11z6wxdtsncCW57L7nGsi7bPrngT7KHmeF/view?usp=share_link1)  
[Занятие 8. Магические методы сравнений](https://drive.google.com/file/d/1Yl2gITiePUZRBjBgzvdwjwQ2oSyTljMe/view?usp=share_link)  
[Занятие 9. Магические методы перебора](https://drive.google.com/file/d/1JASflFudDfgqwZbLHGI5vZJWopI5eHQw/view?usp=share_link)  
[Занятие 10. Наследование и делегирование](https://drive.google.com/file/d/1X7vPm1UEEmfjsfovdZZskWom9_EY7hpx/view?usp=share_link)  
[Занятие 11. Коллекции](https://drive.google.com/file/d/19ktgbvO77kk4QKDOheJOBh-JGYgZt_sg/view?usp=share_link)  
[Занятие 12. Полиморфизм](https://drive.google.com/file/d/1YK7a2dyQa-MqFdPdbscTEFy9_qCsX5Ze/view?usp=share_link)  
[Занятие 13. Блоки try / except](https://drive.google.com/file/d/1a3k62DFZn6yBQBswpa0mgg4XYknZJ53E/view?usp=share_link)  
[Занятие 14. Разбор популярных задач](https://drive.google.com/file/d/17BF3p3QFQlEGl73g6z7jcYwJVOxFXpY5/view?usp=share_link)  
[Занятие 15. Контрольная работа №2](https://drive.google.com/file/d/1cm81Q7Ctve3649dbXlKSByifmePYaPtQ/view?usp=share_link)  
